...
FAST = [
    ...
    Row("wire", "fast", py("tests/unit/t_wire.py"), 2.5,
        "the Wire's two formats (SPEC.md 88.2 and 88.13), from both ends at "
        ...
        "reading on top of that: 88.13 pins its compression BY ITS DECODER, "
    ...
    Row("stkbalance", "fast",
        ...
        "pushed seven registers and popped six, and while Word was outside the "
        "scope the suite stayed green as the machine went to 000E:00DF inside "
        "the interrupt vector table. `ch_legend` pushed SI and never popped it, so "
...
FULL = [
    ...
    Row("thewire", "soak", py("tests/thewire.py"), 340.0,
        ...
        "(SPEC.md 88.14), and SPEC.md 88.6.1's CLIP assertion: after Load "
