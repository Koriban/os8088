...
; the changes rather than the changes alone. SPEC.md 92.1 records both sides.
...
SCA_PICT     equ 27             ; Insert > Picture... (SPEC.md 92.9)
SCA_MAX      equ 27
...
sc_rflush:
    ...
    call sc_picdraw                 ; glyphs for it (SPEC.md 92.9)
    jmp .caret
.notpic:
    cmp word [sc_rcols], 0
    je .caret
...
sc_ftab:
    ...
    dw sc_a_pict                    ; Insert > Picture... (SPEC.md 92.9)

sc_mf_ret:
    ret

; -----------------------------------------------------------------------------
; sc_a_pict - Insert > Picture... (SPEC.md 92.9)
;
...
sc_ovneed:
    ...
    mov [es:sc_pkgseg], ax          ; MODULE ITSELF (SPEC.md 92.8.3). ES is
