...
# ...and PAC-MAN comes off the 360KB disk for the same kind of reason, one
# list over. It arrived from upstream after this geometry's budget was already
# spent, and this fork's SHEET is 51 clusters where upstream's is smaller - so
# the disk came out 5 clusters over 354 and Pac-Man is 8 of them. It ships on
# every roomier geometry, exactly as AUDIO and FONT VIEWER do.
